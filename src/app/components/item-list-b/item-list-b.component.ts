...
@Component({
  selector: 'taiib2-item-list-b',
  standalone: false,
  templateUrl: './item-list-b.component.html',
    providers: [
    FormHideCounterService,
    { provide: ITEM_SERVICE_TOKEN, useExisting: ItemBService }
  ]
})
export class ItemListBComponent implements OnInit {
  items: Item[] = [];
  showForm = false;
